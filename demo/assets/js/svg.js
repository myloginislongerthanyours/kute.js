(function(){
    ...
    var morphTween21 = KUTE.fromTo('#triangle', {attr: { fill: '#673AB7'}, path: '#triangle' }, { attr: { fill: '#2196F3' }, path: '#square' }, {
        impliedRotation: -45, duration: 1500, easing: 'easingCubicOut',
    }); 
    ...
    var multiMorph1 = KUTE.to('#w11', { path: '#w24', attr:{ fill: "#56C5FF" } }, { morphPrecision: 10, duration: 2000, repeat: 1, yoyo: true, easing: 'easingCubicOut'});
    var multiMorph2 = KUTE.to('#w13', { path: '#w21', attr:{ fill: "#56C5FF" } }, { morphPrecision: 10, duration: 2000, repeat: 1, yoyo: true, easing: 'easingCubicOut'});
    var multiMorph3 = KUTE.to('#w14', { path: '#w22', attr:{ fill: "#56C5FF" } }, { morphPrecision: 10, duration: 2000, repeat: 1, yoyo: true, easing: 'easingCubicOut'});
    var multiMorph4 = KUTE.to('#w12', { path: '#w23', attr:{ fill: "#56C5FF" } }, { morphPrecision: 10, duration: 2000, repeat: 1, yoyo: true, easing: 'easingCubicOut'});
    ...
    var compliMorph1 = KUTE.fromTo('#rectangle-container', {path: '#rectangle-container', attr:{ fill: "#2196F3"} }, { path: '#circle-container', attr:{ fill: "#FF5722"} }, { morphPrecision: 10, duration: 2000, repeat: 1, yoyo: true, easing: 'easingCubicOut'});
    var compliMorph2 = KUTE.fromTo('#symbol-left', {path: '#symbol-left'},  { path: '#eye-left' }, { morphPrecision: 10, duration: 2000, repeat: 1, yoyo: true, easing: 'easingCubicOut'});
